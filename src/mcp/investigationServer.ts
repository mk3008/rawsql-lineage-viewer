  ...
  server.registerTool(
    'create_investigation_plan',
    {
      ...
      inputSchema: {
        ...
        ddlFiles: z.unknown().optional(),
        investigationKeys: z.unknown().optional(),
        knownParameters: z.unknown().optional(),
        schemaFactsPath: z.unknown().optional(),
        sql: z.unknown().optional(),
        sqlPath: z.unknown().optional(),
        symptom: z.unknown().optional(),
